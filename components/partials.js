...
export const Image = (props) => {
    ...
    <>
        <ImageWrap className={`${imgLoaded && "loaded"} ${props.layout && "layout"} `}>
            <MyImage  props={props} onLoad={()=>{ setImgLoaded(true)}} width={props.width} height={props.height} src={props.src?.url || props.src} alt={props.alt} priority={true} layout={props.layout} objectFit={props.objectFit}/>
